			...
			<div class="row">
				<div class="12u">
					...
					<section class="box">
						...
						<header style="text-align: center;border-bottom: 1px solid #bbb;margin-bottom:2em">
							<%if(imageUrl != null && !imageUrl.equals("")) { %>
							<div style="background: #dee0e3;height: 250px;overflow: hidden;-webkit-box-shadow: 0px -2px 5px rgba(0, 0, 0, 0.3) inset;-moz-box-shadow: 0px -2px 5px rgba(0, 0, 0, 0.3) inset;box-shadow: 0px -2px 5px rgba(0, 0, 0, 0.3) inset;">
								<img src="<%=imageUrl %>" style="max-width:100%" />
							</div>
							<%} %>
							<h4><a href="<%=url %>" target="_blank"><%=contentTitle %></a></h4>
							<p><%=description %></p>
						</header>
